...
% trials:           Vector specifying when a new trial starts
% FType:            String specifying which spectrum to find
% nBands:           Number of subbands in spectrum
% minFreq:          Minimum frequency of subbands
% maxFreq:          Maximum frequency of subbands
%
% OUTPUT
% featureInfo:      Info about the features that have been found
% features:         Values of the features
%
% AUTHORS OF FUNCTION
% Søren Moeller Christensen, s153571@student.dtu.dk
