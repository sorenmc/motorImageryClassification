function [windowChannel, windowClass, windowTrial] = windowFunctionOurData(data, windowType)
% DESCRIPTION OF FUNCTION
% This function windows the input signal to a given length and with a given
% overlap	
%
% INPUT
% data:             The data struct containing the relevant information
...
% If filter order is not given, then the default order of 4 is used
